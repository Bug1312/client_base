...
public class ClientBaseModBaseInitializer implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		Registry.register(ClientBaseRegistries.RENDERER_TYPE, new Identifier("block_entity"), new BlockEntityRenderer.Deserializer());
		Registry.register(ClientBaseRegistries.RENDERER_TYPE, new Identifier("fake_block"), new FakeBlockRenderer.Deserializer());
		Registry.register(ClientBaseRegistries.RENDERER_TYPE, new Identifier("replace_state"), new BlockModelRenderer.Deserializer());

		Registry.register(ClientBaseRegistries.INTERACTION_TYPE, new Identifier("blockpos"), new BlockPosInteraction.Deserializer());
	...
	void registerBaseInteractions() {
		...
		registerBaseInteraction("video_options", (client) -> client.setScreen(new VideoOptionsScreen(null, client.options)));
	}

	static void registerBaseInteraction(String name, Consumer<MinecraftClient> action) {
		Registry.register(ClientBaseRegistries.POS_INTERACTION, new Identifier(name), action);
	}
